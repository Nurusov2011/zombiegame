...
ground_surf = pygame.image.load("zombiegame\\ground.png").convert()
player_walk1 = pygame.image.load("zombiegame\\player.png").convert_alpha()
player_walk1 = pygame.transform.scale(player_walk1, (96, 152))
player_walk2 = pygame.image.load("zombiegame\\player2.png").convert_alpha()
player_walk2 = pygame.transform.scale(player_walk2, (96, 152))
player_walk3 = pygame.image.load("zombiegame\\player3.png").convert_alpha()
player_walk3 = pygame.transform.scale(player_walk3, (96, 152))
player_walk4 = pygame.image.load("zombiegame\\player4.png").convert_alpha()
player_walk4 = pygame.transform.scale(player_walk4, (96, 152))
player_walk5 = pygame.image.load("zombiegame\\player5.png").convert_alpha()
player_walk5 = pygame.transform.scale(player_walk5, (96, 152))
player_shoot = pygame.image.load("zombiegame\\playershoot.png").convert_alpha()
...
mouse_pos = pygame.mouse.get_pos()
target_surf = pygame.image.load("zombiegame\\crosshair.png").convert_alpha()
target_surf = pygame.transform.scale(target_surf, (32, 32))
target_pos = get_center_mouse(mouse_pos)
zombie_surf = pygame.image.load("zombiegame\\idle0000.png").convert_alpha()
zombie_rect = zombie_surf.get_rect()
zombie_x = randint(0, BOUNDS_X - zombie_rect.width)
zombie_y = 50
zombie_speed = 10
zombies = 1
bullet_surf = pygame.image.load("zombiegame\\bullet.png").convert_alpha()
...
shoot_sound = pygame.mixer.Sound("zombiegame\\shootsound.mp3")
colliding = False
Game_Active = False
is_shooting = False
shoot_duration = 500
